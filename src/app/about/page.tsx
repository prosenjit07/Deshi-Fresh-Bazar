      ...
      <div className="bg-gray-50 py-12">
        <div className="container">
          ...
          <div className="prose prose-gray max-w-none rounded-lg bg-white p-8">
            ...
            <p>দেশি ফ্রেশ বাজার বাংলাদেশের অন্যতম শীর্ষস্থানীয় অনলাইন ফলের বাজার। ২০২০ সাল থেকে আমরা গ্রাহকদের সেরা মানের তাজা ফল সরবরাহ করে আসছি। আমাদের লক্ষ্য হল গ্রাহকদের দরজায় সর্বোচ্চ মানের ফল পৌঁছে দেওয়া।</p>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>৬০+ কৃষকের সাথে সরাসরি চুক্তি</li>
